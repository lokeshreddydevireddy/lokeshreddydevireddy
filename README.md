...
I'm a final-year Information Technology student at Dhanekula Institute of Engineering & Technology and a Cloud Engineering Intern at Edubot Software & Services. My current work focuses on AWS, Linux, networking, IAM, cloud infrastructure, and deployment workflows. Alongside cloud work, I build web applications with React, Node.js, Express.js, and MongoDB. I use Git and GitHub for version control and project collaboration. I'm currently strengthening my DevOps and cloud engineering skills through practical work and hands-on projects. I'm interested in software development, backend systems, cloud engineering, and DevOps roles where I can build useful systems and grow through real engineering work.
...
- Configuring **IAM users, groups, policies, and MFA** for secure cloud access.
- Performing **Linux administration and server management** tasks.
- Using **Git and GitHub** for version control and collaboration.
- Working with **networking, security groups, and cloud architecture**.
- Deploying and managing cloud-based applications and infrastructure.
...
A full-stack employee leave management application for handling employee leave requests, approvals, attendance, and related workflows.

**Stack:** React · Node.js · Express.js · MongoDB

**Focus:** Full-stack development · REST APIs · Database-driven application

---

### Vaultfy

A cloud file-storage and sharing platform inspired by Google Drive, designed around storing and sharing important career documents and credentials.

**Stack:** Cloud Storage · Web Application Development
...
My current hands-on cloud work is focused on understanding how applications, infrastructure, identity, networking, and monitoring work together.

| Area | Hands-on Work |
|---|---|
| **AWS** | EC2, S3, IAM, VPC, CloudWatch, SNS |
| **Identity & Security** | IAM users, groups, policies, MFA, security groups |
| **Networking** | VPCs, subnets, routing, security groups |
| **Linux** | Administration and server management |
| **Deployment** | Cloud-based application and infrastructure deployment |
| **Version Control** | Git and GitHub |
| **Web Infrastructure** | Nginx and Node.js |
...
**Software Development · Backend Development · Cloud Engineering · DevOps · Full Stack Development**

I'm interested in roles where I can work on real applications, backend systems, cloud infrastructure, deployment, and practical engineering problems.
...
### Building software. Working with cloud. Growing through practice.
